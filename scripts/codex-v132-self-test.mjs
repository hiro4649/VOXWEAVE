...
const cases = [
  ...
  ['repository_identity_and_profile_match', () => manifest.targetRepository === REPOSITORY && manifest.targetRepoProfile === 'VOXWEAVE' && candidate.repositoryFullName === REPOSITORY && candidate.profileClass === PROFILE],
