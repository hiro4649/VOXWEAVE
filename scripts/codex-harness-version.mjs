...
export const versionLineagePolicy = {
  ...
  sourceReleaseTargetRolloutStatus: 'not_started',
  sourceReleaseRepresentativeLivePrValidationStatus: 'not_started',
  targetRepoStateAuthority: 'target_manifest',
  targetRepoStateMustNotBeInferredFromSourceRelease: true,
