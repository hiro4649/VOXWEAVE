...
v1.3.0 Core installs only the full quality gate target profile and v111-v129 compatibility bridge. v1.2.9 remains immediate rollback, v1.2.8 remains blocking compatibility, and v1.2.7 remains readable compatibility. It does not create owner authority.
