...
For v1.1.8 Final Decision Kernel and Mode-Aware Evidence Contract, use docs/process/CODEX_V118_SPEC.md. Preserve v1.1.7 safety while separating final execution decisions from domain Decision Capsules, require Evidence Capsule freshness, keep mode-aware artifact contracts, and preserve the eight-status operator surface.
