...
export function buildIntegrationBoundarySnapshot({
  ...
  return {
    ...
    operational_boundary: {
      ...
      lifecycle_bounds_enforced: true,
      connection_cap_enabled: true,
      write_admission_enabled: true,
      write_queue_enabled: false,
      write_overload_rejection_enabled: true,
      health_bypasses_write_admission: true,
      admission_lease_release_on_failure: true,
      request_abort_safe_classification: true,
      destroyed_response_write_guard: true,
      client_error_safe_response: true,
      expect_continue_allowed: false,
      forced_shutdown_available: true,
      idle_connection_cleanup_available: true,
      shutdown_timer_cleanup_required: true,
      safe_startup_summary: true,
      safe_shutdown_summary: true,
      transport_values_excluded: true,
      application_operation_deadline_bounded: true,
      client_disconnect_cancellation_enabled: true,
      server_to_service_abort_signal: true,
      orchestrator_cooperative_cancellation: true,
      live2d_parent_signal_propagation: true,
      live2d_local_timeout_preserved: true,
      parent_abort_distinguished_from_renderer_timeout: true,
      cache_commit_after_cancellation_prevented: true,
      render_group_commit_after_cancellation_prevented: true,
      external_side_effect_rollback_guaranteed: false,
      operation_timeout_safe_error: true,
      operation_cancellation_safe_error: true,
      operation_deadline_values_excluded: true,
      active_operation_counts_excluded: true,
    },
    tts_boundary: {
      mode: "mock_only",
