# VOXWEAVE Third-Pass Open PR Classification v1.2.3

## Executive Summary

This docs-only classification records the remaining open PR inventory after the first and second v1.2.3 stale evidence cleanup passes. It does not close, merge, repair, or modify any existing open PR.
...
currentMainHeadSha: eb2cb7f408a9ba962eb38be3cadf35db7351cbc6
firstCleanupClosedCount: 9
secondCleanupClosedCount: 14
postSecondCleanupBaselineSha: eb2cb7f408a9ba962eb38be3cadf35db7351cbc6
...
openPrCount: 119
openDraftPrCount: 116
safeStaleDocsOnlyCandidateCount: 2
needsOwnerReviewCount: 114
activeCandidateCount: 3
nonVoxweaveScopeOrExternalCount: 0
closeRecommendationYesCount: 2
closeRecommendationPendingCount: 114
...
already_closed_first_or_second_cleanup: PRs #279 #278 #277 #275 #274 #271 #270 #268 #267 #265 #264 #262 #261 #258 #257 #255 #254 #252 #251 #249 #248 #246 #245 are already closed and are not reclassified here.

safe_stale_docs_only_candidate: Open draft docs-only evidence where current metadata is enough to recommend closure after this classification audit is merged.

needs_owner_review: Open draft work whose title or metadata may involve product verification, readiness, diagnostic, preserve, policy, failed route, runtime, or decision evidence. These remain pending until separately inspected.

active_candidate: Non-draft open PRs or otherwise active candidates. These are not close candidates in this audit.

non_voxweave_scope_or_external: No non-VOXWEAVE repo PRs are included in this inventory.

## PR Classification Records

### PR #241

prNumber: 241
title: VOXWEAVE Route-Level Contract Tests Post-Merge Sentinel v1.1.8
url: https://github.com/hiro4649/VOXWEAVE/pull/241
state: open
draftStatus: true
baseSha: bc1f86207b139647d39970915b3495215678498f
headSha: 01d27272e85b5d3839fb68d5eb817aca91b140e2
harnessVersionObserved: v1.1.8
classification: safe_stale_docs_only_candidate
mergeRecommendation: no
closeRecommendation: yes
reason: open draft route-level acceptance or post-merge evidence already superseded by current v1.2.3 main
riskIfClosedBlindly: low if closed after classification audit is merged
riskIfLeftOpen: stale evidence remains in open PR list
safeNextAction: close only after this classification audit is merged

### PR #239

prNumber: 239
title: VOXWEAVE Route-Level Contract Tests Acceptance Audit v1.1.8
url: https://github.com/hiro4649/VOXWEAVE/pull/239
state: open
draftStatus: true
baseSha: 71e5cb7d95b4cf1802d4d1abd839b46237f3db75
headSha: d02ac10df1306164c10d40c14c5b5bad9050d25a
harnessVersionObserved: v1.1.8
classification: safe_stale_docs_only_candidate
mergeRecommendation: no
closeRecommendation: yes
...
reason: metadata alone is insufficient for a safe close decision in this pass
riskIfClosedBlindly: could lose product, diagnostic, preserve, policy, readiness, or decision evidence
riskIfLeftOpen: open PR inventory remains noisy
safeNextAction: inspect under separate owner-scoped cleanup
...
reason: non-draft open PR requires separate review
riskIfClosedBlindly: could close active work without owner review
riskIfLeftOpen: keeps active candidate visible
...
This is a docs-only classification. The test commands cover the active harness self-test, v1.2.2 compatibility self-test, and the bounded package test suite after adding the classification document.

## Safe Next Action

After this classification audit is reviewed and merged, close only the safe_stale_docs_only_candidate PRs. Inspect needs_owner_review and active_candidate PRs under separate owner-scoped cleanup.
